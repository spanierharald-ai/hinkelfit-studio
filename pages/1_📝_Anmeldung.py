...
• **Befolgen von Anweisungen:** Den Anweisungen des Trainers bezüglich Übungsausführung und Sicherheitsbestimmungen ist stets Folge zu leisten. Eigenmächtiges Abweichen erfolgt auf eigene Gefahr.""")
    ...
    if st.button("🚀 Jetzt verbindlich anmelden"):
      ...
      # Variablen vorab definieren
                ...
                sig_html = '<img src="data:image/png;base64,' + img_base64 + '" style="margin-top: 10px; border: 1px solid #ccc; width: 250px;">' if img_base64 else ""

                # HTML-Struktur mit klassischem String-Plus (100% sicher vor Syntaxfehlern)
                html_contract = (
                    ...
                    '<div class="field"><span class="label">Vertragsdatum:</span> ' + heute_str + '</div>'
                    ...
                    '<div class="field">Rechtsverbindlich digital unterschrieben von <strong>' + st.session_state.vorname + ' ' + st.session_state.nachname + '</strong> am ' + heute_str + '</div>'
                    + sig_html +
                    '</body></html>'
                )
